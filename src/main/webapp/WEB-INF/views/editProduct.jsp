...
<div>
    <h2 class="container2">Edit Product ${product.name}</h2>

    <form class="form-signin" action="<c:url value="/servlet/admin/edit-product?p_id=${product.id}"/>" method="post">
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit" value="${product.id}">Edit</button>
    </form>
</div>
